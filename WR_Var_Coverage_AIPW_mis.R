...
#############################################################
################ Variance Coverage of AIPW estimator (outcome model is misspecified)##################
#############################################################
...
res
write.csv(res,file="C:/Users/82655/Dropbox/research/covariate adjustment win ratio/AIPW_mis_unb_200.csv")  
